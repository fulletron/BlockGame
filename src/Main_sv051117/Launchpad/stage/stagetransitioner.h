...
#include <Launchpad/transition/itransitioner.h>
...
public:
	...
	_UINT32 StageTransitioner<MACHINE>::armForTransitions(GS::Transition::TransRecipe a_currentOut, GS::State::IState<MACHINE> * a_pNextStage, GS::Stage::IHasStageTransitioner * a_pNextTrans, GS::Transition::TransRecipe a_nextIn)
	{
