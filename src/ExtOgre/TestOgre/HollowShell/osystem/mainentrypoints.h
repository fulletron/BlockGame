...
#ifndef _MAINENTRYPOINTS_H_
#define _MAINENTRYPOINTS_H_
...
namespace OGraphics
{
    ...
    */
    ...
    public:
        ...
        */
        static void createSystems( IGameState **outGraphicsGameState, GraphicsSystem **outGraphicsSystem,
                                   IGameState **outLogicGameState, LogicSystem **outLogicSystem );

        /// Destroys the systems created via createSystems. Implementation should check for null pointers.
        static void destroySystems( IGameState *graphicsGameState, GraphicsSystem *graphicsSystem,
                                    IGameState *logicGameState, LogicSystem *logicSystem );
