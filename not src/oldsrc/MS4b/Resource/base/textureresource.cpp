...
namespace ResourceNS {
	_UINT32 TextureResource::init(GS::Game * a_rpGame, const char * a_filename, const bool & a_generateMipMaps)
	{
		m_rpGame = a_rpGame;
	...
	_UINT32 TextureResource::loadFromFile(const char * a_filename, bool a_generateMipMaps)
	{
	...
	void TextureResource::bindTexture(_UINT32 a_textureUnit)
	{
	...
	void TextureResource::setFiltering(_INT32 a_tfMagnification, _INT32 a_tfMinification)
	{
	...
	void TextureResource::setSamplerParameter(GLenum a_parameter, GLenum a_value)
	{
		glSamplerParameteri(m_glSampler, a_parameter, a_value);
	}

	void TextureResource::createFromData(_BYTE* bData, int a_iWidth, int a_iHeight, int a_iBPP, GLenum format, bool bGenerateMipMaps)
	{
